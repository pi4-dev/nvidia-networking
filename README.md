...
The original repository state is preserved in branch [`v0.01`](https://github.com/pi4-dev/nvidia-networking/tree/v0.01), at commit `6071fa9f05b7ea5e116094f518fd4b6c15992867`. Subsequent baselines are [`v0.02`](https://github.com/pi4-dev/nvidia-networking/tree/v0.02) at `d52782bd3ba8d282d1e999ba16b4f2073f501b67` and [`v0.03`](https://github.com/pi4-dev/nvidia-networking/tree/v0.03) at `a2a41c6210a3267068daae0b387a31fa0c49cee2`, followed by [`v0.04`](https://github.com/pi4-dev/nvidia-networking/tree/v0.04) at `231c96fe07230279edfe8817da89528c754ee4e5`, and [`v0.05`](https://github.com/pi4-dev/nvidia-networking/tree/v0.05) at `8035ee9ecb537f1738af2a95ac469a5dfece50ff`. Further development is on `main` (`0.06-dev`). The validator now checks complete 1→N cable/optical breakouts and connection projects, with physical port conflict detection, shared inventory, a consolidated BOM, JSON project interchange and CSV link import/export. Installation planning adds rack and port markings, stable cable IDs, shared breakout head labels, installed/checked states, and PDF/XLSX exports. Project JSON preserves this metadata. The interactive map shows devices, cable/breakout assemblies, compatibility, cage conflicts, and physical occupancy separately from logical split interfaces, with filters and zoom. Exact hardware evidence and the connection assistant remain available. CI runs data/rule/API/frontend regressions and a Docker Compose smoke test.

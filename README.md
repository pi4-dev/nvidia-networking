...
The original repository state is preserved in branch [`v0.01`](https://github.com/pi4-dev/nvidia-networking/tree/v0.01), at commit `6071fa9f05b7ea5e116094f518fd4b6c15992867`. The preceding validator is preserved in [`v0.02`](https://github.com/pi4-dev/nvidia-networking/tree/v0.02) at `d52782bd3ba8d282d1e999ba16b4f2073f501b67`. Further development is on `main` (`0.03-dev`), including exact hardware/firmware/OS profiles with dated evidence and a connection assistant that compares cable or module–fiber–module proposals with inventory reuse. CI runs data/rule/API/browser regressions and a Docker Compose smoke test.

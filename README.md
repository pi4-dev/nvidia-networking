...
The original repository state is preserved in branch [`v0.01`](https://github.com/pi4-dev/nvidia-networking/tree/v0.01), at commit `6071fa9f05b7ea5e116094f518fd4b6c15992867`. Subsequent baselines are [`v0.02`](https://github.com/pi4-dev/nvidia-networking/tree/v0.02) at `d52782bd3ba8d282d1e999ba16b4f2073f501b67` and [`v0.03`](https://github.com/pi4-dev/nvidia-networking/tree/v0.03) at `a2a41c6210a3267068daae0b387a31fa0c49cee2`. Further development is on `main` (`0.04-dev`). The validator now checks complete 1→N cable/optical breakouts and connection projects, with physical port conflict detection, shared inventory, a consolidated BOM, JSON project interchange and CSV link import/export. Exact hardware evidence and the connection assistant remain available. CI runs data/rule/API/frontend regressions and a Docker Compose smoke test.
